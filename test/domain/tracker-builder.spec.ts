...
describe('Smart Banners tracker link building', () => {
  ...
  describe('No custom data', () => {
    it('builds common tracker', () => {
      ...
      expect(buildSmartBannerUrl(DeviceOS.WindowsPC, trackerData, emptyUrl, emptyCustomData)).toBe(expected);
    });
    ...
    it('builds ios tracker with plain deeplink', () => {
      ...
      expect(buildSmartBannerUrl(DeviceOS.iOS, trackerData, emptyUrl, emptyCustomData)).toBe(expected);
    });
    ...
    it('builds android tracker with plain deeplink', () => {
      ...
      expect(buildSmartBannerUrl(DeviceOS.Android, trackerData, emptyUrl, emptyCustomData)).toBe(expected);
    });
  });
  ...
  describe('Uses URL parameters for interpolation', () => {
    it('builds ios tracker with deeplink template', () => {
      ...
      expect(buildSmartBannerUrl(DeviceOS.iOS, trackerData, 'https://some-path/?page=hello', emptyCustomData)).toBe(expected);
    });
    ...
    it('builds android tracker with deeplink template', () => {
      ...
      expect(buildSmartBannerUrl(DeviceOS.Android, trackerData, 'https://some-path/?page=hello', emptyCustomData)).toBe(expected);
    });
  });
  ...
  describe('Custom deeplink context', () => {
    it('builds ios tracker with plain deeplink', () => {
      ...
      expect(buildSmartBannerUrl(DeviceOS.iOS, trackerData, emptyUrl, { iosDeepLinkPath: customDeepLinkPath })).toBe(expected);
    });
